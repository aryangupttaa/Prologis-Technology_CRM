...
) ENGINE=InnoDB AUTO_INCREMENT=79 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is the branches table that are linked to organizations';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store client data and employee that created the client ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `setworkflow` VALUES (1,'Air Import','Raxaul','Apexsea Logistics Pvt Ltd','Seawave Forwarding Logistics','seawave@2323','Job Creation Date','Before','2','12','45',0,'Scrutiny Document','[{\"username\": \"aayush@manager\"}, {\"username\": \"rishi@manager\"}]'),(2,'Air Import','Raxaul','Apexsea Logistics Pvt Ltd','Seawave Forwarding Logistics','seawave@2323','','','','','',1,'ETA','[{\"username\": \"hemang@executive\"}]'),(3,'Air Import','Raxaul','Apexsea Logistics Pvt Ltd','Seawave Forwarding Logistics','seawave@2323','Scrutiny Document','After','2','1','15',0,'ESanchit','[{\"username\": \"aayush@manager\"}, {\"username\": \"rishi@manager\"}]'),(4,'Air Import','Raxaul','Apexsea Logistics Pvt Ltd','Seawave Forwarding Logistics','seawave@2323','ESanchit','After','5','12','30',0,'Duty Call','[{\"username\": \"hemang@executive\"}, {\"username\": \"rishi@manager\"}]'),(5,'Sea Import','Raxaul','null','Seawave Forwarding Logistics','seawave@2323','Scrutiny Document','Before','2','12','00',0,'Port/CFS Nomination','[{\"username\": \"rishi@manager\"}, {\"username\": \"hemang@executive\"}]'),(6,'Sea Import','Raxaul','null','Seawave Forwarding Logistics','seawave@2323','Job Creation Date','After','1','00','00',0,'Scrutiny Document','[{\"username\": \"rishi@manager\"}, {\"username\": \"aayush@manager\"}]'),(7,'Sea Import','Raxaul','null','Seawave Forwarding Logistics','seawave@2323','Checklist Approval','After','3','2','1',0,'ESanchit','[{\"username\": \"rishi@manager\"}, {\"username\": \"shreyash@executive\"}]'),(8,'Sea Import','Raxaul','null','Seawave Forwarding Logistics','seawave@2323','Port/CFS Nomination','Before','1','12','45',0,'Checklist Approval','[{\"username\": \"rishi@manager\"}, {\"username\": \"aayush@manager\"}, {\"username\": \"hemang@executive\"}]');
...
INSERT INTO `trackingimport` VALUES (9,'ESanchit','2024-04-25T03:01:00.000Z','2024-05-25T13:10','724 hr 39 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','A/I/1/24-25','rishi@manager','2d 1hr 15min','Air Import','Raxaul','Raxaul-2323','Apexsea Logistics Pvt Ltd'),(10,'Duty Call','2024-04-30T15:31:00.000Z','2024-05-25T13:11','592 hr 10 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','A/I/1/24-25','rishi@manager','5d 12hr 30min','Air Import','Raxaul','Raxaul-2323','Apexsea Logistics Pvt Ltd'),(11,'Scrutiny Document','2024-04-23T01:46:00.000Z','2024-05-25T13:11','773 hr 55 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','A/I/1/24-25','rishi@manager','2d 12hr 45min','Air Import','Raxaul','Raxaul-2323','Apexsea Logistics Pvt Ltd'),(14,'Scrutiny Document','2024-05-22T21:01:00.000Z','2024-05-25T15:17','60 hr 46 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','24-25/A/Raxaul/I//xyzabc/3','rishi@manager','2d 12hr 45min','Air Import','Raxaul','Raxaul-2323','Apexsea Logistics Pvt Ltd'),(18,'Checklist Approval','2024-05-21T09:30:00.000Z','2024-05-25T15:31','96 hr 31 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','24-25/S/Raxaul/I//xyzabc/2','rishi@manager','1d 12hr 45min','Sea Import','Raxaul','Raxaul-2323','null'),(19,'Scrutiny Document','2024-05-25T10:15:00.000Z','2024-05-25T15:31','-1 hr -14 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','24-25/S/Raxaul/I//xyzabc/2','rishi@manager','1d 00hr 00min','Sea Import','Raxaul','Raxaul-2323','null'),(20,'Port/CFS Nomination','2024-05-22T22:15:00.000Z','2024-05-25T15:31','59 hr 46 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','24-25/S/Raxaul/I//xyzabc/2','rishi@manager','2d 12hr 00min','Sea Import','Raxaul','Raxaul-2323','null'),(21,'Port/CFS Nomination','2024-05-22T22:15:00.000Z','2024-05-25T15:31','59 hr 46 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','24-25/S/Raxaul/I//xyzabc/2','rishi@manager','2d 12hr 00min','Sea Import','Raxaul','Raxaul-2323','null'),(22,'Checklist Approval','2024-05-21T09:30:00.000Z','2024-05-25T15:31','96 hr 31 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','24-25/S/Raxaul/I//xyzabc/2','rishi@manager','1d 12hr 45min','Sea Import','Raxaul','Raxaul-2323','null'),(23,'Scrutiny Document','2024-05-25T10:15:00.000Z','2024-05-25T15:31','-1 hr -14 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','24-25/S/Raxaul/I//xyzabc/2','rishi@manager','1d 00hr 00min','Sea Import','Raxaul','Raxaul-2323','null');
