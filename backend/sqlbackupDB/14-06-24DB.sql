...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is to store the general component data ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is where all creation of job in import will be stored';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `impjobcreation` VALUES ('24-25/S/Raxaul/I/xyzabc/2','2024-06-09 11:48:00','2024-06-04 11:48:00','Sea','Kolkata Sea','Yes','Destuff',3,'Yes','Ex-Bond','LCL','fdgf','dfhdfg','MBL/MAWB','goku','Seawave Forwarding Logistics','seawave@2323','shreyash@executive',1,6,'Surrender','t67','OneTime',2,'Raxaul','Raxaul-2323'),('24-25/S/Raxaul/I/xyzabc/4','2024-06-12 15:59:00','2024-06-10 15:59:00','Sea','Jogbani LCS','No','Destuff',7,'No','Ex-Bond','Break Bulk','dummy','dfgf','MBL/MAWB','dgdfhgd','Seawave Forwarding Logistics','seawave@2323','hemang@executive',2,5,'Original','rr45','OneTime',4,'Raxaul','Raxaul-2323'),('Jogbani/S/24-25/I/yy/1','2024-06-13 16:07:00','2024-06-11 16:07:00','Sea','Raxaul LCS','Yes','Destuff',3,'No','Ex-Bond','LCL','dummy','dfhdfg','MBL/MAWB','goku','Seawave Forwarding Logistics','seawave@2323','hemang@executive',3,5,'Surrender','t67','OneTime',1,'Jogbani','Jogbani-2323'),('24-25/S/Raxaul/I/xyzabc/5','2024-06-13 18:02:00','2024-06-09 18:02:00','Sea','Jogbani LCS','Yes','Destuff',2,'No','Ex-Bond','Break Bulk','dummy','dfgf','HBL/HAWB','dgdfhgd','Seawave Forwarding Logistics','seawave@2323','shreyash@executive',4,5,'Surrender','rr45','OneTime',5,'Raxaul','Raxaul-2323'),('24-25/S/Raxaul/I/xyzabc/6','2024-06-14 15:09:00','2024-06-12 15:09:00','Sea','Raxaul LCS','Yes','Destuff',7,'No','SEZ-Z','Break Bulk','dummy','dfgf','MBL/MAWB','dgdfhgd','Seawave Forwarding Logistics','seawave@2323','hemang@executive',5,5,'Surrender','rr45','OneTime',6,'Raxaul','Raxaul-2323');
...
CREATE TABLE `reminders` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store reminders for import';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-06-14 15:45:20
